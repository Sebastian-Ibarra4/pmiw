//Sebastian Ibarra 120321/3
//Paulina Caballe 120284/7
let imagenes = [];
let imagenActual;
...
let mensajes = [
  ...
  "*Encontraron el secreto de la montaña magica!*", //15
...
function manejarSeleccionOpcion(opcion) {
  switch (indiceMensajeActual) {
    ...
    case 7: 
      ...
      break;
    case 8: 
      indiceMensajeActual = 12; // Cambia directamente a nt.13 
      break;
    case 9: 
    ...
    case 14: 
      if (opcion === "Finalizar") {
        indiceMensajeActual = 14; // Cambiar a la pantalla con la imagen nt.12
      }
      break;
